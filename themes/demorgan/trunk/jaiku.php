			<li id="widget-jaiku" class="widget">
				...
				<?php
					if (is_array($presences)) {
						...
						printf('<li class="jaiku-more"><a href="%s">' . _t('Read more…', 'demorgan') . '</a></li>', $presences[0]->user->url);
					} else
					if ($presences instanceof JaikuPresence) {
						...
						printf('<li class="jaiku-more"><a href="%s">' . _t('Read more…', 'demorgan') . '</a></li>', $presences->user->url);
					} else
					{
