...
<div id="x-<?php echo $post->id; ?>-<? echo $version['id']; ?>" class="versiontitle"><?php echo 
$post->title_out; ?> <?php echo $version[ 'habari_version' ]; ?>-<?php echo $version[ 
'version' ]; 
?></div>

<div class="versioncontent container span-16">
	<div class="version_info column span-6">
		<h3>Download</h3>
...
<?php		if ($version['url']) : ?>
		<li>theme Link: <a href="<?php echo $version['url']; ?>" title="More information about this theme"><?php _e("click here"); ?></a></li>
<?php		endif; ?>
		<li>&nbsp;</li>
		<li>&nbsp;</li>
		<li>&nbsp;</li>
	...
	<div class="plugin_tabs_container span-10 last">
		...
		<h3>Screenshot</h3>
		<a href="<?php 
		$thumb = preg_replace('/600x500/','300x250',$version[ 'screenshot' ]);
		echo $version['screenshot']; ?>" title="<?php echo $post->title_out ?> Screenshot" class="thickbox"><img src="<?php 
		echo $thumb; ?>" alt="screenshot of <?php echo $post->title_out; ?>"></a>
		</div><!-- /screenshot -->
