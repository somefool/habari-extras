...
class Typekit extends Plugin {
	...
	public function info()
	{
		return array( 
			...
			'description' => 'Embeds Typekit script in headers.',
		);
	}
	...
	{
		$help = _t( 'Once configured, the Embed Code generated for your Typekit fonts kit will be added to your headers, as long as your theme calls <code>&lt;?php $theme->header(); ?&gt;</code>.' ); 
		return $help;
	}
