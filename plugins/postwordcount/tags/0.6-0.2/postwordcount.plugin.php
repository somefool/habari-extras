...
class PostWordCount extends Plugin
{
	...
	public function info()
	{
		return array(
			...
			'url' => 'http://mikelietz.org/code/habari/counters.php',
			'author' =>'Mike Lietz',
			'authorurl' => 'http://mikelietz.org',
			'version' => self::VERSION,
			'description' => 'Counts words in a single post',
	...
	{
		return str_word_count( strip_tags( ( $this->config[ 'add_title' ] ? $post->content_out . " {$post->title}" : $post->content_out ) ) ); 	}
}
?>
