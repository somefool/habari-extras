...
/**
 * THIS PLUGIN WILL ONLY WORK WITH 0.6 IF r3631 IS MERGED INTO THE 0.6 RELEASE.
 * In Habari's htdocs directory:
 * svn merge -r3630:3641 http://svn.habariproject.org/habari/trunk/htdocs
 */
class SimpleGallery extends Plugin
{
	...
	function info()
	{
		return array (
			...
			'authorurl' => 'http://twofishcreative.com/',
			'version' => '0.1',
			'description' => 'Takes a directory structure of images and turns it into an image gallery.',
