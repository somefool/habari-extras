...
class Sitemaps extends Plugin {
	...
	{
		$help = _t( '<p>This plugin will generate a <a href="http://sitemaps.org">sitemaps.org</a> compatible sitemap of your Habari blog for consumption by search engines like Ask.com, Google, Microsoft and Yahoo!.  A stylesheet is also included to make the sitemap visually appealing for the curious viewers.</p>' );
		return $help;
	}
