...
class OhlohBadge extends Plugin
{
	...
	{
		return _t( 'Configure, then use <code>&lt;?php $theme->ohloh_badge(); ?></code> in your theme to output the HTML image markup.' );
	}
	...
	public function info()
	{
		return array(
			...
			'author' => 'Philip Olson',
			'authorurl' => 'http://blog.roshambo.org/',
			'version' => '0.1',
			'description' => 'Displays an ohloh badge within your blog.',
		);
	}
